...
/**
 * Default luxury brands list (always displayed in luxury section)
 * These brands ALWAYS appear in the luxury section
 * Additional brands are auto-added if they have cars >= 150M
 */
export const LUXURY_BRANDS = [
  'Rolls-Royce', 'Bentley', 'Lamborghini', 'Ferrari', 'Porsche',
  'Maserati', 'Aston Martin', 'McLaren', 'Bugatti', 'Mercedes-Benz'
]
